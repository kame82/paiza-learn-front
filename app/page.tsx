  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center md:p-24 p-8">
      <div className="max-w-4xl w-full">
        <h2 className="text-3xl mb-4">Code Learn App</h2>
      </div>
      <div className="max-w-4xl w-full">
        <div className=" w-full max-w-xs text-gray-800">
          <div className="mt-1">
            <select
              value={language}
      ...
      <textarea
        className="max-w-4xl w-full mx-auto md:h-40 h-20 p-2 border text-black mt-4"
        readOnly={true}
        value={value}
      />
    </main>
